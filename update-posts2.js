...
// Placeholder images (using picsum.photos which returns actual images)
const PH = {
  wide1: 'https://picsum.photos/seed/freshoh1/1200/500',
  wide2: 'https://picsum.photos/seed/freshoh2/1200/500',
  sq1: 'https://picsum.photos/seed/freshoh3/800/600',
  sq2: 'https://picsum.photos/seed/freshoh4/800/600',
  sq3: 'https://picsum.photos/seed/freshoh5/800/600',
  col1: 'https://picsum.photos/seed/freshoh6/600/800',
  col2: 'https://picsum.photos/seed/freshoh7/600/800',
  full1: 'https://picsum.photos/seed/freshoh8/1600/600',
};
...
// Post 1: 체계적인 운영 — add full-width gallery, images in columns
const post1 = findPost('체계적인');
if (post1) {
  const existing = JSON.parse(post1.content);
  const blocks = [
    ...
    // Full-width single image gallery
    { type: 'gallery', data: { layout: 'full', width: 'full', image1: PH.full1, image2: '', image3: '', caption: '프레시오 운영 현장' }},
    ...
    { type: 'spacer', data: { size: 'md' }},
    // Wide 2-equal gallery
    { type: 'gallery', data: { layout: '2-equal', width: 'wide', image1: PH.sq1, image2: PH.sq2, image3: '', caption: '현장 분석 과정' }},
    { type: 'spacer', data: { size: 'lg' }},
    ...
    { type: 'columns', data: {
      image: PH.col1,
      heading: '데이터 대시보드 설계',
      text: '<p>일별 매출 추이, 상품별 기여율, 재주문율, NPS 점수까지 — 모든 숫자가 한 화면에서 읽히도록 설계했습니다. 운영자가 매일 아침 확인하는 습관을 만드는 것이 목표였습니다.</p>',
      layout: 'image-left',
      ratio: '1:1',
      width: 'wide'
    }},
    ...
    // 3-up gallery
    { type: 'gallery', data: { layout: '3-up', width: 'full', image1: PH.sq1, image2: PH.sq2, image3: PH.sq3, caption: '현장 운영 프로세스 개선' }},
    { type: 'spacer', data: { size: 'md' }},
    { type: 'paragraph', data: { text: '가장 큰 변화는 현장 운영자의 자신감이었습니다. 감으로 판단하던 것을 숫자로 설명할 수 있게 되면서, 본사와의 커뮤니케이션도 달라졌습니다.' }},
    { type: 'delimiter', data: {}},
...
// Post 2: 고객경험 — add columns with image, asymmetric gallery
...
if (post2) {
  const blocks = [
    ...
    { type: 'gallery', data: { layout: 'full', width: 'full', image1: PH.wide2, image2: '', image3: '', caption: '' }},
    { type: 'spacer', data: { size: 'lg' }},
    ...
    { type: 'paragraph', data: { text: '프레시오가 선택한 답은 1인 반상차림이었습니다. 단순한 메뉴 변경이 아닙니다. 한 사람을 기준으로 경험을 다시 설계하는 것입니다.' }},
    // Columns with image — wide, 2:1
    { type: 'columns', data: {
      image: PH.col2,
      heading: '1인 반상차림의 원칙',
    ...
    // Asymmetric gallery (left large)
    { type: 'gallery', data: { layout: '1-large-r', width: 'wide', image1: PH.sq1, image2: PH.sq3, image3: '', caption: '현장 교육과 시연' }},
    { type: 'paragraph', data: { text: '주방 팀과 함께 상차림을 연습했습니다. 왜 이렇게 해야 하는지, 이것이 고객에게 어떤 의미인지를 설명했습니다.' }},
    ...
    { type: 'paragraph', data: { text: '구글 리뷰, SNS, 입소문에서 "무난하다"는 표현이 사라졌습니다. 대신 "정돈되어 있다", "깔끔하다", "신경 쓴 느낌이 난다"는 표현이 늘어났습니다.' }},
    { type: 'delimiter', data: {}},
...
// Post 3: BX 재설계 — add columns with image, full gallery
...
if (post3) {
  const blocks = [
    ...
    // Full-width panorama
    { type: 'gallery', data: { layout: 'full', width: 'full', image1: PH.wide1, image2: '', image3: '', caption: '쉴낙원 서울' }},
    { type: 'spacer', data: { size: 'lg' }},
    ...
    // Columns with image, right, 2:1 ratio
    { type: 'columns', data: {
      image: PH.col1,
      heading: '디지털 접점 재설계',
    ...
    // Asymmetric gallery (right large)
    { type: 'gallery', data: { layout: '1-large-l', width: 'wide', image1: PH.sq2, image2: PH.sq3, image3: '', caption: '브랜드 산출물 디테일' }},
    ...
    { type: 'paragraph', data: { text: '설계된 브랜드 경험은 현장에서 사람을 통해 전달됩니다. 아무리 정제된 산출물이 있어도, 응대하는 사람의 태도가 다르면 브랜드는 무너집니다.' }},
    // Full-width columns, 3:1
    { type: 'columns', data: {
      image: PH.col2,
      heading: '접객 표준 정립',
      text: '<p>친절보다 존중, 속도보다 정확성. 누가 응대하더라도 동일한 온도와 태도가 유지되도록 구조를 맞추는 데 집중했습니다.</p>',
      layout: 'image-left',
      ratio: '3:1',
      width: 'full'
    }},
    ...
    { type: 'paragraph', data: { text: '장례식장에서 일하는 사람들은 눈에 띄는 일을 하지 않습니다. 그러나 그들이 하는 일은 세상에서 가장 중요하고 조심스러운 일입니다.' }},
...
// Post 4: 육개장 — add columns with image, full gallery
...
if (post4) {
  const blocks = [
    ...
    // Full-width hero
    { type: 'gallery', data: { layout: 'full', width: 'full', image1: PH.full1, image2: '', image3: '', caption: '' }},
    { type: 'spacer', data: { size: 'lg' }},
    ...
    { type: 'paragraph', data: { text: '이번 프로젝트의 출발점은 단순한 레시피 개선이 아니었습니다. 수도권 육개장 맛집과 대구 지역 대표 매장을 직접 방문해 국물의 농도, 향의 깊이, 대파·고사리 사용 방식을 비교했습니다.' }},
    // 2-equal gallery
    { type: 'gallery', data: { layout: '2-equal', width: 'wide', image1: PH.sq1, image2: PH.sq2, image3: '', caption: '시장 조사 및 비교 분석' }},
    ...
    { type: 'columns', data: {
      image: PH.col2,
      heading: '현장 시연과 교육',
      text: '<p>직접 끓여 보여드리고, 전후 차이를 함께 맛보게 했습니다. 결과가 설득보다 강했고, 그제야 현장의 손이 움직이기 시작했습니다.</p>',
      layout: 'image-right',
      ratio: '2:1',
      width: 'full'
    }},
    ...
    { type: 'paragraph', data: { text: '이 프로젝트의 결론은 단순합니다. 표준화된 공정만으로, 조리자가 누구든 동일한 품질의 육개장을 매일 재현할 수 있다는 것을 증명했습니다.' }},
    // 3-up gallery full
    { type: 'gallery', data: { layout: '3-up', width: 'full', image1: PH.sq1, image2: PH.sq2, image3: PH.sq3, caption: '완성된 소고기능이육개장' }},
    { type: 'delimiter', data: {}},
...
console.log('Posts updated with placeholder images and full-width blocks');
